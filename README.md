## Kaly Chain Testnet Faucet

### Building from source

1. Clone repository
  ```
  git clone https://github.com/KalyCoinProject/testnet-faucet
  ```
...
5. Run faucet with `npm start`. The faucet will be launched at `http://localhost:5000`
...
```
{
  ...
  "Ethereum": {
    ...
    "prod": {
      "rpc": "JSON RPC endpoint. For example, https://testnetrpc.kalycoin.io/rpc",
